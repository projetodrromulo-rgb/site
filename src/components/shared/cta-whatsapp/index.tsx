...
export function CtaWhatsApp({ cta, className }: WhatsAppButtonProps) {
    return (
        <div className={className}>
            <a
                className={cn(
                    "w-full animate-pulse transition-all duration-300 relative z-30 flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#25D366]/90 text-white py-5 rounded-xl font-extrabold text-lg shadow-lg shadow-[#25D366]/20 transition-all active:scale-95 group",
