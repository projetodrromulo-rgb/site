...
export default function About({ content }: AboutProps) {
    ...
    return (
        <section id="sobre" className="relative w-full overflow-hidden bg-neutral-light border-b border-primary-dark/5 lg:pt-16 pt-24">
            ...
            <div className="relative px-6 md:px-12 lg:px-8 xl:px-16 2xl:px-64 text-primary-dark max-w-8xl mx-auto w-full space-y-20 lg:space-y-24 bg-neutral-light lg:pb-16">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-8 w-full">
                        ...
                        <motion.div
                            ...
                            className=" space-y-6 text-primary-dark/70 text-lg md:text-xl leading-relaxed lg:text-left order-1 lg:order-2 flex-1"
                        >
