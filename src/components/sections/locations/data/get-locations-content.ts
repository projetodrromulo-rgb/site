...
const localLocationsContent: LocationsContent = {
    ...
    units: [
        {
            ...
            image: "/images/location/hospital-03.webp",
            mobileImage: "/images/location/hospital-03-mobile.webp"
        },
        {
            id: "clinica-centra",
            ...
            mobileImage: "/images/location/clinica-02-mobile.webp"
        },
        {
            ...
            mobileImage: "/images/location/clinica-01-mobile.webp"
        },
        {
            id: "clinica-numai",
            title: "Clínica NUMAI",
        ...
        },
        {
            ...
            mobileImage: "/images/location/clinica-03-mobile.webp"
        },
        {
            id: "hospital-biocor",
            ...
            image: "/images/location/hospital-02.webp",
            mobileImage: "/images/location/hospital-02-mobile.webp"
        }
    ]
};
...
export async function getLocationsContent(): Promise<LocationsContent> {
    ...
    try {
        ...
        if (data) {
            return {
                subtitle: data.subtitle || localLocationsContent.subtitle,
                headline: {
                    textTop: data.headline?.textTop || localLocationsContent.headline.textTop,
                    textHighlight: data.headline?.textHighlight || localLocationsContent.headline.textHighlight,
                    styles: localLocationsContent.headline.styles
                },
                description: data.description || localLocationsContent.description,
                units: data.units && data.units.length > 0
                    ? data.units.map((u: any, idx: number) => ({
                        ...
                        image: u.image?.src || localLocationsContent.units[idx]?.image || "",
                        mobileImage: u.image?.src || localLocationsContent.units[idx]?.mobileImage || ""
                    }))
                    : localLocationsContent.units
            };
        }
    } catch (error) {
        console.error("Error fetching locations content from Sanity, falling back to local data:", error);
    }
