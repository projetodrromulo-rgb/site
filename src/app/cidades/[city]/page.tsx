...
export default async function CityPage({ params }: { params: Promise<{ city: string }> }) {
    ...
    const physicianJsonLd = {
        ...
        "address": {
            "@type": "PostalAddress",
            "streetAddress": data.slug === "betim" ? "Via Expressa de Betim, 15500 - Duque de Caxias" : "Avenida Coronel José Dias Bicalho 928, bairro São Luiz/Pampulha",
            "addressLocality": data.name,
            "addressRegion": "MG",
            "postalCode": data.slug === "betim" ? "32673-472" : "31275-050",
            "addressCountry": "BR"
        },
        "geo": data.slug === "betim" ? {
            "@type": "GeoCoordinates",
