...
export const beloHorizonteData: CityData = {
  slug: "belo-horizonte",
  name: "Belo Horizonte",
  title: "Especialista em Coluna em Belo Horizonte | Dr. Rômulo Oliveira",
  ...
  keywords: [
    ...
    "clinica de coluna em belo horizonte",
    "tratamento de hernia de disco em belo horizonte",
    "dor nas costas belo horizonte",
    "ortopedista em belo horizonte",
    "cirurgiao de coluna belo horizonte",
    "clinica numai belo horizonte",
    "clinica elcenter barreiro belo horizonte"
  ],
  heroContent: {
    typingPhrases: [
