...
export const metadata: Metadata = {
  ...
  description: "Ortopedista Especialista em cirurgia de coluna minimamente invasiva. Atendimento em Belo Horizonte, Betim e Contagem. Recupere sua qualidade de vida.",
